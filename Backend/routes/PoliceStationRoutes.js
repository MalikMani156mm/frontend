...
router.route('/PoliceStations').get(isAuthenticatedUser,isAuthorizedUser('SuperAdmin','Admin','Citizen'),getAllPoliceStations);
router.route('/PoliceStation/:id').get(isAuthenticatedUser,isAuthorizedUser('SuperAdmin','Admin','Citizen'),getPoliceStationById);
